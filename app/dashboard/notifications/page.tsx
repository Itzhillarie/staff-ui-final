    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-wrap justify-end gap-3">
        <button
          ...
          disabled={unread === 0}
          className="inline-flex items-center gap-2 rounded-xl border border-slate-300 bg-white px-5 py-3 font-semibold text-slate-700 transition hover:bg-cyan-50 disabled:cursor-not-allowed disabled:opacity-50"
        >
          <CheckCheck size={18} />
          Mark all read
        </button>
        <Link
          ...
          className="inline-flex items-center gap-2 rounded-xl border border-slate-300 bg-white px-5 py-3 font-semibold text-slate-700 transition hover:bg-cyan-50"
        >
          <Archive size={18} />
          Archive
        </Link>
